  ...
  return (
    <div>
      ...
      <section id="faq" className="faq-section container">
        <h1 className="h1-center">Frequently Asked Questions (FAQ)</h1>
        <div className="accordion" id="faqAccordion">
          ...
          <div className="accordion-item">
            ...
            <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
              <div className="accordion-body">Ya, semua produk kami datang dengan garansi satu tahun untuk cacat pabrik. Untuk informasi lebih lanjut tentang garansi, Anda bisa menghubungi layanan pelanggan kami.</div>
            </div>
          </div>
          <div className="accordion-item">
          ...
          <div className="accordion-item">
            <h2 className="accordion-header" id="headingFive">
              <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                Apakah Anda menerima pesanan custom?
              </button>
            </h2>
            <div id="collapseFive" className="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#faqAccordion">
              <div className="accordion-body">Ya, kami menerima pesanan custom sesuai dengan spesifikasi Anda. Silakan hubungi tim layanan pelanggan kami untuk mendiskusikan kebutuhan Anda lebih lanjut.</div>
            </div>
          </div>
        </div>
      </section>
